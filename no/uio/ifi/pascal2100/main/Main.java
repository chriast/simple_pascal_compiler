...
public class Main {
	public static final String version = "2015-11-4";

	public static Library library;// Del 3
	...
	public static void main(String arg[]) {
		System.out.println("This is the Ifi Pascal2100 compiler (" + version
				+ ")");
		System.out
				.println("Implemented by <mikkelmb@student.mn.uio.no> and Christopher Andreas Storvik <chriast@student.mn.uio.no>");
